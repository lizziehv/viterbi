...
public class SudiTrigram {
    ...
    /**
     * @param probability can either be transition or observation
     * @return logarithmic score of the probability
     */
    public static double score(double probability){
    ...
    public ArrayList<Map<String, String>> predictNext(String sentence) {
        ...
        for (String word : words) {
            ...
            // add the next state to the end of the list
            states.add(nextState);
    ...
    public static void main(String[] args) {
        ...
        if (debugFlag) {
            ...
            SudiTrigram test = new SudiTrigram();
        ...
        if (simpleTest) {
            ...
            SudiTrigram simpleTrainTest = new SudiTrigram();
        ...
        if (brownTest) {
            ...
            SudiTrigram brownTrainTest = new SudiTrigram();
